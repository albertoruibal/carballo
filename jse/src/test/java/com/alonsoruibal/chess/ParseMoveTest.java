...
class ParseMoveTest {
	...
	@Test
	void testGetFromStringCastlingInInitialPosition() {
		Board b = new Board();
		b.startPosition();
	...
	@Test
	void testGetFromStringDisambiguateOneMoveNotLegal() {
	...
	void testBugSanGg6() {
		...
		b.doMove(move);
		assertEquals("none", Move.toSan(b, move), "Converts move g6 as gg6 if the move is done, and it must return none if the move is not legal");
	}
}